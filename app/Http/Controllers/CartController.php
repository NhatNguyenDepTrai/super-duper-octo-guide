...
class CartController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if (!$coupon) {
            ...
            return view('frontend.pages.cart')->with('coupon_error', 'Please select a coupon code');
        } else {
            if (!$coupon['id']) {

                return view('frontend.pages.cart')->with('coupon_error', 'Invalid counpon');
            } else {
                $coupon = Coupon::where('code', $coupon['code'])->where('status', 'active')->exists();
                if(!$coupon){

                    return view('frontend.pages.cart')->with('coupon_error', 'Expired');
                }
            }
        }
