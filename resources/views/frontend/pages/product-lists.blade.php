...
@if (isset($meta_seo))
    @section('title', $meta_seo['meta_title'].'  Archives  ')
    @section('meta_title', $meta_seo['meta_title'].'  Archives  ')
    @section('meta_image', url($meta_seo['meta_image']))
@else
    @section('title',' Shop')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="{{url()->full()}}">
                                    @if (isset($meta_seo))
                                    {{$meta_seo['meta_title']}} Archives
                                    @else
                                    Shop List
                                    @endif
                                </a></li>
