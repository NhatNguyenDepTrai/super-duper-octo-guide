                ...
                @foreach ($banners as $key => $banner)
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        ...
                        <div class="carousel-caption d-none d-md-block text-left">
                            ...
                            <h5 class="text-light" style="color: white">{!! html_entity_decode($banner->description) !!}</h5>
                    ...
                    <div class="product-info">
                        <div class="nav-main">
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                @endphp
                                @if ($categories)
                                    <button class=" btn_category how-active1" style=""data-filter="*">
                                        All Products
                                    </button>
                                    @foreach ($categories as $key => $cat)
                                        <button class=" btn_category" style=""data-filter=".{{ $cat->id }}">
                                            {{ $cat->title }}
                                        </button>
                                    @endforeach
                                @endif
